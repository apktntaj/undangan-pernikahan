        ...
        <>
                    ...
                    <div className="relative">
                      <div className="ml-6 md:ml-0 md:flex md:items-center">
                        ...
                        <div className="md:w-1/2 md:pl-8">
                          ...
                          <p className="text-gray-600 md:hidden">Maret 2021</p>
                          <p className="text-gray-600 mt-2">Calon istri saya adalah junior magang di tempat saya bekerja.</p>
                        </div>
                      </div>
                    </div>
                    <div className="relative">
                      <div className="ml-6 md:ml-0 md:flex md:items-center">
                        <div className="md:w-1/2 md:pr-8 text-right hidden md:block">
                          ...
                          <p className="text-gray-600">Juni 2021</p>
                        </div>
                        <div className="absolute left-0 md:left-1/2 mt-3 md:mt-0 -ml-3 md:-ml-3">
                          <div className="w-6 h-6 bg-rose-400 rounded-full"></div>
                        </div>
                    ...
                    <div className="relative">
                      <div className="ml-6 md:ml-0 md:flex md:items-center">
                        ...
                        <div className="md:w-1/2 md:pl-8">
                          ...
                          <p className="text-gray-600 mt-2">Empat tahun waktu yang lebih dari cukup untuk melamar.</p>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="max-w-4xl mx-auto text-center space-y-12">
              ...
              <div className="grid md:grid-cols-2 gap-12">
                <div className="space-y-4 group">
                  ...
                  <div>
                    <h3 className="font-serif text-2xl text-gray-800">Alam Asy'arie</h3>
                    <p className="text-gray-600 mt-2">Putra Pertama dari</p>
                    <p className="text-gray-800 font-medium">Bpk. Arifuddin Achmad & Ibu Asiawati</p>
                  </div>
                </div>
                <div className="space-y-4 group">
                  <div className="relative">
                  ...
                  <div>
                    <h3 className="font-serif text-2xl text-gray-800">Siti Fatimah</h3>
                    <p className="text-gray-600 mt-2">Putri Kedua dari</p>
                    <p className="text-gray-800 font-medium">Bpk. Andi Makmun & Ibu Cicih</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="py-20 px-4 bg-white">
            <div className="max-w-4xl mx-auto text-center space-y-12">
                ...
                <div className="bg-rose-50 p-8 rounded-2xl shadow-lg transform hover:-translate-y-1 transition-all duration-300">
                  ...
                  <div className="space-y-2 text-gray-600">
                    ...
                    <p className="flex items-center justify-center gap-2">
                      ...
                      Kampung Jawa, Jl Raya BT 003 Kec Sukawangi Kec Sukamakmur Kab. Bogor.
                    </p>
                  </div>
                </div>
              ...
              <div className="pt-8">
                <a
                  href="https://maps.app.goo.gl/DLbBHrw5JzemrkS49"
                  target="_blank"
